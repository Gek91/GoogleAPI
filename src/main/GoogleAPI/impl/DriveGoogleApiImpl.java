...
import main.GoogleAPI.DriveGoogleApi;
...
//		
//	@Override
//	public void addFilePermissions(String executionGoogleUser, String fileId, List<Permission> permissions) {
...
//			
//			List<List<Permission>> partitions = ListUtils.partition(permissions, 50);
//			
//			for(List<Permission> partition : partitions) {
//				
//				BatchRequest batchRequest = getDriveGoogleService(executionGoogleUser).batch();
//
//				for(Permission permission : partition) {
//					
//					getDriveGoogleService(executionGoogleUser).permissions()
//						.create(fileId, permission)
//						.setSendNotificationEmail(false)
//						.queue(batchRequest, new BatchGoogleCallback());
//				}
//				
//				
//			}
...
//					new JsonBatchCallback<Void>() { //TODO
//
//				      @Override
...
//	}
	...
	@Override
	public FileList getFileList(String executionGoogleUser, String fields, String orderBy, String query,
			Integer pageSize, String nextPageToken) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public File createFile(String executionGoogleUser, String name, List<String> parentsIds, InputStream fileData,
			String contentType, boolean keepRevisionForever, String fields) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public File updateFileMetadata(String executionGoogleUser, String fileId, String name, Set<String> addParentIds,
			Set<String> removeParentIds, Map<String, String> properties, Date lastModifyDatetime) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Permission addPermission(String executionGoogleUser, String fileId, DriveFilePermissionTypeEnum type,
			DriveFilePermissionRoleEnum role, String value) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Permission updatePermission(String executionGoogleUser, String fileId, DriveFilePermissionTypeEnum type,
			DriveFilePermissionRoleEnum role, String value) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	protected AbstractGoogleServiceBatchRequest<Drive> getBatchBuilder(String executionGoogleUser) {
		// TODO Auto-generated method stub
		return null;
	}
}
